...
class NepaliDateFormat {
  /// Creates a new NepaliDateFormat
  /// with the [pattern] and [language] specified.
  NepaliDateFormat(
    String pattern, [
    Language? language,
  ...
  /// Return a string representing [date] formatted
  /// according to assigned [_pattern] and [_language].
  ...
  /// Converts the formatted date string into a string representing [dateString]
  /// formatted according assigned [_pattern] and [_language].
